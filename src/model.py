...
########################################################################################################
# RWKV: RWKV Time-mix + RWKV Channel-mix TimeX
########################################################################################################
...
class RWKV_TimeMix(nn.Module):
    ...
    def RUN_PYTORCH(self,w, k, B, C, T, eps):
